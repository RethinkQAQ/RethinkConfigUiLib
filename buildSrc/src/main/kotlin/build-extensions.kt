...
val Project.common get() = requireNotNull(stonecutterBuild.node.sibling("common")) { "No common project for $project" }
...
value class ModData(private val project: Project) {
    ...
    val unobfuscated: Boolean
        get() = mc.substringBefore('-').split('.').firstOrNull()?.toIntOrNull()?.let { it >= 26 } == true
